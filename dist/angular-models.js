(function() {
  ...
  angular.module('angular-models').service('LifecycleMixin', function() {
    return {
      dependencies: function() {
        return this._state = null;
      },
      setLifecycle: function(state, model) {
        if (model == null) {
          model = this;
        }
        return model._state = state;
      },
      getLifecycle: function(model) {
        if (model == null) {
          model = this;
        }
        return model._state;
      },
      isLifecycle: function(state, model) {
        if (model == null) {
          model = this;
        }
        return model._state === state;
      },
      hasLifecycle: function(model) {
        if (model == null) {
          model = this;
        }
        return this.getLifecycle(model) != null;
      },
      isLoaded: function(model) {
        if (model == null) {
          model = this;
        }
        return model._state === 'loaded';
      },
      isDirty: function(model) {
        if (model == null) {
          model = this;
        }
        return model._state === 'dirty';
      },
      isSaving: function(model) {
        if (model == null) {
          model = this;
        }
        return model._state === 'saving';
      },
      isFetching: function(model) {
        if (model == null) {
          model = this;
        }
        return model._state === 'fetching';
      },
      isDeleted: function(model) {
        if (model == null) {
          model = this;
        }
        return model._state === 'deleted';
      },
      isError: function(model) {
        if (model == null) {
          model = this;
        }
        return model._state === 'error';
      },
      isNew: function(model) {
        if (model == null) {
          model = this;
        }
        return model._state === 'new';
      },
      isValid: function(model) {
        if (model == null) {
          model = this;
        }
        return model._state === 'valid';
      }
    };
  });

  angular.module('angular-models').factory('Model', function($rootScope, $http, $filter, Module, NameMixin, LifecycleMixin, AttributesMixin) {
    var Model;
    Model = (function(_super) {
      ...
      Model.prototype.fetch = function() {
        ...
        return $http.get(this._getUrl()).success(success).error(error);
      };
